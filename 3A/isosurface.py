...
if __name__ == "__main__":
	...
	parser.add_argument('--val', '-v', type=int, metavar='int', help='Initial Isovalue', default=DEFAULT_CONTOUR_VAL)
	parser.add_argument('--clip', '-c' , type=int, metavar='int', nargs=3,
						help='Initial coordinates of cutting planes', default=DEFAULT_PLANE_POS)
